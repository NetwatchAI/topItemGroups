...
class CWidgetFieldColumnsList extends CWidgetField {
	...
	public const DATA_GROUP_NAME = 4;
	...
	protected function getValidationRules(bool $strict = false): array {
		$validation_rules = ['type' => API_OBJECTS, 'fields' => [
			...
			'data'					=> ['type' => API_INT32, 'flags' => API_REQUIRED, 'in' => implode(',', [self::DATA_ITEM_VALUE, self::DATA_HOST_NAME, self::DATA_TEXT, self::DATA_GROUP_NAME])],
