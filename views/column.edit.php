...
$form = (new CForm())
	->setId('topitemgroups_column_edit_form')
	->setName('topitemgroups_column')
	...
	new CFormField(
		(new CSelect('data'))
			...
			->addOptions(CSelect::createOptionsFromArray([
				...
				CWidgetFieldColumnsList::DATA_GROUP_NAME => _('Group name'),
...
$time_period_field_view = (new CWidgetFieldTimePeriodView($data['time_period_field']))
	...
	->setFormName('topitemgroups_column');
...
$form_grid
	...
	->addItem(new CScriptTag([
		'document.forms.topitemgroups_column.fields = {};',
...
$form
	...
	->addItem(
		(new CScriptTag('
			topitemgroups_column_edit_form.init('.json_encode([
				'form_id' => $form->getId(),
...
$output = [
	...
	'buttons'		=> [
		[
			...
			'keepOpen'	=> true,
			'isSubmit'	=> true,
			'action'	=> 'topitemgroups_column_edit_form.submit();'
		]
	]
];
